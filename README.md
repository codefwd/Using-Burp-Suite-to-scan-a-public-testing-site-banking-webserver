...
In the image below, the panel shows messages that have come in and gone out from the web site. The panels below that shows the browser request and server response details.
